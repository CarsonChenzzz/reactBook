		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Route, { path: '/list/:page', component: List }),
	...
	var App = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'nav',
					{ className: 'navbar navbar-inverse navbar-static-top container' },
					React.createElement(
						'div',
						{ className: 'container' },
						React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'a',
										{ href: 'http://www.chen7.online/ver/map.html' },
										'\u60F3\u4E0D\u60F3\u4E0A\u8F66\uFF1F'
									)
								)
							)
		...
		render: function render() {
			...
			if (this.state.list.length > 0) {
				...
				for (var i = 0; i < 9; i++) {
					...
					lstOne.push(React.createElement(
						'div',
						...
						React.createElement(
							...
							React.createElement(
								NavLink,
								{ to: detailUrl, className: 'btn btn-danger', role: 'button' },
								'\u8001\u94C1\uFF01\u70B9\u51FB\u5C31\u9001 \xBB'
							)
						)
					));
				...
				for (var i = 9; i < 18; i++) {
					var detailUrl = "/detail/" + data[i].id;
					lstTwo.push(React.createElement(
						'div',
						{ className: 'col-lg-4', key: i },
						React.createElement('img', { className: 'img-rounded',
							src: data[i].images.large,
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							{ className: 'featurette-heading indexTitle' },
							'\u300A',
							showOneTitle,
							'\u300B',
					...
					React.createElement(
						'div',
						{ className: 'col-md-4' },
						React.createElement('img', { className: 'featurette-image img-responsive center-block', src: showOneImg, alt: '500x500', 'data-holder-rendered': 'true' })
					)
				),
				React.createElement('hr', { className: 'featurette-divider' }),
				React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-8 col-md-push-4' },
						React.createElement(
							'h2',
							{ className: 'featurette-heading indexTitle' },
							'\u300A',
					...
					React.createElement(
						'div',
						{ className: 'col-md-4 col-md-pull-8' },
						React.createElement('img', { className: 'featurette-image img-responsive center-block', src: showTwoImg, alt: '500x500', 'data-holder-rendered': 'true' })
					)
				),
				React.createElement('hr', { className: 'featurette-divider' }),
				React.createElement(
		...
		render: function render() {
			if (this.state.list.length > 0) {
				...
				for (var i = 1; i < pageLast + 1; i++) {
					...
					pages.push(React.createElement(
						NavLink,
						{ to: listUrl, className: 'btn btn-default', role: 'button', key: i },
						i
					));
				}
			}
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						NavLink,
						{ to: '/list/1', className: 'btn btn-default', role: 'button' },
						'\u9996\u9875'
					),
					React.createElement(
						NavLink,
						{ to: prePageUrl, className: 'btn btn-default', role: 'button' },
						'\u4E0A\u4E00\u9875'
					),
					pages,
					React.createElement(
						NavLink,
						{ to: nextPageUrl, className: 'btn btn-default', role: 'button' },
						'\u4E0B\u4E00\u9875'
					),
					React.createElement(
						NavLink,
						{ to: finishUrl, className: 'btn btn-default', role: 'button' },
						'\u5C3E\u9875'
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = __webpack_require__(229);
	...
	var Detail = React.createClass({
		...
		render: function render() {
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'p',
								{ className: 'lead' },
								thisBook.author_intro
							)
						),
						React.createElement(
							'div',
							{ className: 'col-md-3' },
							React.createElement('img', { className: 'featurette-image img-rounded center-block', src: thisBook.image, alt: '500x500', 'data-holder-rendered': 'true', width: '220', height: '300' })
						)
					),
					React.createElement('div', { className: 'clearfix' }),
					React.createElement(
			...
			return React.createElement(
				...
				null,
				book,
				React.createElement(CommentBox, { id: this.props.params.id })
			);
		}
	});
	...
	var CommentList = React.createClass({
		...
		render: function render() {
			var commentNodes = this.props.data.map(function (comment, idx) {
				return React.createElement(Comment, { author: comment.author, text: comment.text, key: idx });
			});

			return React.createElement(
				'div',
				{ className: 'commentList  well' },
				commentNodes
			);
		}
	});
	...
	var CommentForm = React.createClass({
		...
		render: function render() {
			return (
				...
				React.createElement(
					'form',
					{ className: 'commentForm form-horizontal row', onSubmit: this.handleSubmit },
					React.createElement(
						'div',
						...
						React.createElement(
							'div',
							{ className: 'col-sm-10' },
							React.createElement('input', { className: 'form-control', type: 'text', ref: 'author', id: 'formGroupInputLarge', placeholder: '\u8BF7\u8F93\u5165\u4F60\u5728\u79CB\u540D\u5C71\u98D9\u8F66\u65F6\u7684\u6CD5\u53F7' })
						)
					),
					React.createElement(
						'div',
						...
						React.createElement(
							'div',
							{ className: 'col-sm-10' },
							React.createElement('input', { className: 'form-control', type: 'text', ref: 'text', id: 'formGroupInputSmall', placeholder: '\u8BF7\u8868\u8FF0\u60A8\u5BF9\u5373\u5C06\u4E0A\u5C71\u7684\u65B0\u53F8\u673A\u7684\u5FE0\u544A\uFF0C\u5C3D\u91CF\u4E0D\u8981\u591ABB' })
						)
					),
					React.createElement('input', { type: 'submit', value: '\u8001\u53F8\u673A -- \u5343\u5E74\u6740', className: 'btn btn-success btn-lg btn-block' })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = React.createClass({
		...
		saveReport: function saveReport(event) {
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'text', ref: 'searchTag', name: 'tag', className: 'form-control input-lg ', placeholder: '\u8F93\u5165\u4F60\u60F3\u8981\u5BFB\u627E\u7684\u90A3\u4E00\u8EAB\u6E7F\uFF08\u4E0D\u8981\u8F93\u5165\u7A7A\u683C\uFF09' }),
					React.createElement('input', { type: 'submit', value: '\u4E0A\u8F66 GOGOGO', onClick: this.saveReport, className: 'btn btn-warning col-sm-3 btn-lg pull-right' })
				),
				React.createElement('div', { className: 'clearfix' }),
				React.createElement('br', null),
				React.createElement('br', null),
